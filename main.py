...
tf.flags.DEFINE_integer('batch_size', 256, 'training batch size')
tf.flags.DEFINE_float('learning_rate', 1e-3, 'learning rate')
tf.flags.DEFINE_integer('display_step', 30, 'display for every n batch')
